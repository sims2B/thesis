...
Cette sous-section, dédié à la présentation des résultats obtenus pour les
...
sur les instances de la Famille 1 présentée dans la
sous-section~\ref{sec:instance_CECSP} et avec une limite de temps de 
...
\hline 
    \end{tabularx}
  \end{center}
  \caption{Résultats du modèle Start/End pour le \CECSP.} 
  \label{tab:SE_CECSP}
\end{table}
