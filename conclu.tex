...
ait une durée et une consommation de ressource fixes durant son 
...
variables, ont été introduits~\cite{DDH,NK,FT,Kis,BLN}. Cette thèse
...
formes quasi quelconques. De ce fait, un des premiers travaux
effectués dans cette thèse a été une étude détaillée du
problème. Cette étude a permis de décrire des cas particuliers du
\CECSP~pouvant être résolus en temps polynomial mais aussi a permis,
dans certains cas, la mise en place d'une propriété permettant de
simplifier le problème en caractérisant les différentes formes que
peut prendre une activité.  Cette simplification du problème a ensuite
été utilisée pour mettre en place des méthodes de résolution pour le
\CECSP, souvent adaptées de méthodes existantes dans le cadre des
problèmes d'ordonnancement cumulatifs.
