...
d'intervalle, alors aucun autre intervalle ne pourra conduire à une à
prouver l'insatisfiabilité de l'instance. La taille de cet ensemble
d'intervalle d'{\it intérêt} est de l'ordre de $O(n^2)$.

Récemment, Derrien{\it et al.} ont proposé une caractérisation plus
fine de l'ensemble des intervalles d'intérêt pour le raisonnement
énergétique. L'ordre de grandeur de la taille de cet ensemble
d'intervalle n'est pas modifié et est toujours de l'ordre de $n^2$
mais le nombre d'intervalles considérés est divisé par $7$. En effet,
la caractérisation de Baptiste{\it et al.} considère, pour chaque
paire d'activités, $15$ intervalles tandis que la caractérisation de
Derrien {\it et al.} n'en considère que $2$.
