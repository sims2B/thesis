...
\begin{ex}
  ...
  Soient $3$ variables, $x_0,\ x_1$ et $x_2$, de domaine
...
détection d'incohérences}, aussi appelés checker, permettent de
refuser une instanciation des variables si cette dernière n'est pas
cohérente. Ils peuvent aussi être étendus de manière à détecter une
incohérence en cours de recherche si aucune solution n'est contenu
dans le sous-arbre courant.
\begin{ex}
