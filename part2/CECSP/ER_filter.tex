...
-t_2+t_1-\ES) - c_{ip}(t_2-t_1)\right)\]
   ...
   \begin{figure}[!htb]
     \input{part2/CECSP/derivative4.tex}
     \caption{Intervalle d'intérêt du raisonnement énergétique du
...
\begin{figure}[!htb]
 \subcaptionbox{Cas $\ES \le t_1 $  \label{fig:variation1}}[\linewidth] {
   \input{part2/CECSP/derivative1.tex} }
 \subcaptionbox{Cas $\ES > t_1 \ge \smax$
   \label{fig:variation2}}[\linewidth]{
  \input{part2/CECSP/derivative2.tex}}
 \subcaptionbox{Cas $\LE > t_1 \ge \smax $
