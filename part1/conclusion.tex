...
la consommation de ressource nous a permis de présenter un nouveau
problème: le \CECSP. 
...
plus, le profil variable de consommation de la ressource rend la
résolution de ce problème a priori délicate. En effet, dans le cas
général, la quantité de ressource allouée à une activité peut varier à
tout moment ce qui accroît la difficulté de résolution puisque
l'inconnue est une fonction de $\mathbb{R}$ dans $\mathbb{R}$. 
...
que ses points de rupture correspondent aux dates de début et de fin
