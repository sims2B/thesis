...
\section{L'ordonnancement sous contraintes de ressource}\subsection{Problèmes cumulatifs}
...
résolution. Dans la section~\ref{section_modele_RCPSP}, nous présentons des
...
Dans la section~\ref{section_etat_CUSP}, nous présenterons des
