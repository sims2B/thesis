...
cette durée est aussi supposée fixe. Cependant, pour de nombreux problèmes
pratiques, ces suppositions reviennent à sur-contraindre le
problème. En effet, considérons l'exemple suivant, décrit dans~\cite{FT}.
Dans cette exemple, une activité représentant
...
personnes en seulement un jour. Si l'on avait supposé une consommation
et une durée fixe, l'espace des solutions aurait été réduit. 
...
Le reste de la modélisation du problème est décrit dans la section
